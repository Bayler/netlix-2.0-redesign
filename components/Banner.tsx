...
function Banner({ netflixOriginals }: Props) {
    ...
    }, [netflixOriginals]) //dependent on netflixOriginals
    ...
    return (
        ...
        lg:pb-12">
            ...
            <div className="flex space-x-3">
                ...
                <button className="bannerButton bg-[gray]/70">More Info <InformationCircleIcon className="h-5 w-5 md:h-8 w-8"/></button>
            </div>
        </div>
    )
    }
